...
function Hemel(ranData, bigData, smallData, i) {
  ...
  const ref = useD3((svg) => {
    ...
    var yScale = d3.scaleLinear().domain([1000, 2000]).range([height, 0]);
    // create axis objects
      ...
      .on("click", function (event, j) {
        tooltip
          ...
          .html( function (d) {
            ...
            let geslacht = ""
            if (bigData[j.z].prs_geslacht == "Vrouw" || bigData[j.z].prs_geslacht == "Meisjes") {
              geslacht = "vrouw"
            }
            else if (bigData[j.z].prs_geslacht == "Man" || bigData[j.z].prs_geslacht == "Jongens") {
              geslacht = "man"
            }
            ...
            return "<span>" + bigData[j.z].prs_naam + "<img src='/" + geslacht + ".svg'>" + "</span>" + "<img>" + "<span>" + "Leeftijd: " + "<strong>" + leeftijd + "</strong>" + "</span>" + "<span>" + "<input id='meer' type='checkbox' value=" + j.z + ">" + "<label for='meer'> Meer informatie </label>" + "<img src='/pijl.svg'>" + "</span>"
        });
      })
      ...
      .on("click", function (event, j) {
        tooltip
          ...
          .html( function (d) {
            ...
            // eslint-disable-next-line no-useless-concat
            return "<span>" + smallData[j.z].Naam + "<img src='/" + geslacht + ".svg'>" + "</span>" + "<img>" + "<span>" + "Leeftijd: " + "<strong>" + leeftijd + "</strong>" + "</span>" + "<span>" + "<input id='meer' type='checkbox' value=" + j.z + ">" + "<label for='meer'> Meer informatie </label>" + "<img src='/pijl.svg'>" + "</span>"
        });
      })
